...
public class PlayerTest {
    ...
    @Test
    public void isEnoughMoneyToPay() {
    ...
    @Test
    public void isHaveChoicePayJail() {
    ...
    /* This test is to check if freeProperty() can free the player's properties when the player is about to lose */
    @Test
    public void freeProperty() {
        ...
        player.purchaseProperty(Central);
        player.purchaseProperty(WanChai);

        //check the player has properties
        assertFalse(player.getProperties().isEmpty());
        player.freeProperty();
        //no properties because the function is called
        assertNull(player.getProperties());
    }
}
